    ...
    <Box sx={{overflow:"hidden"}}>
      ...
      >
        ...
        <Typography
          ...
          sx={{ mt: 2, textAlign:"center",maxWidth:{sm:"80vw",lg:"60vw"}, lineHeight: 1.6 ,fontSize:{xs:"2.8vw",lg:"1vw"}}}
          data-aos="fade-up"
        >
      ...
      >
          ...
          <motion.div whileHover={{ scale: 1.05 }} transition={{ duration: 0.3 }}>
            <Box
              sx={{
                ...
                border: {xs:"4px solid #A30D33",lg:"8px solid #A30D33"},
                borderRadius: "12px",
                overflow: "hidden",
        ...
        <Grid item xs={12} md={6} data-aos="fade-right">
          ...
          <Typography  sx={{ lineHeight: 1.6,width:{xs:"100%",lg:"40vw"},fontSize:{xs:"4vw",lg:"1.2vw"} }}>
