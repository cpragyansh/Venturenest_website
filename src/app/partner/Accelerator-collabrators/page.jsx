  ...
  useEffect(() => {
    ...
    const fetchPartners = async () => {
      try {
        ...
        setPartners(response.data); // Store fetched data in state
      } catch (err) {
  ...
  return (
    <div className="partners-container">
      ...
      <div className="partners-content">
        <h2 className="eco-partners-title">Accelerator Collaborators</h2>
<div className="gov-description-wrapper">
  <p className="gov-description">
    We  <strong>work closely</strong> with key government bodies and state-led startup missions that act as catalysts for policy support, regulatory guidance and public-sector innovation alignment to accelerate the growth of startups in our ecosystem.
 </p>
