...
export default function TechInnovCouncil() {
  ...
  useEffect(() => {
    ...
    axios.get((window.API_BASE_URL || (window.API_BASE_URL || 'https://venturenestbackend.cgcuniversity.in')) + '/council-members?category=techInnov')
      .then(response => {
           ...
           <div className="relative w-full flex flex-col items-center justify-center mb-12 py-2">
             ...
             <div className="relative z-10 flex flex-col items-center">
                ...
                <p className="text-gray-600 max-w-2xl text-center text-lg font-medium leading-relaxed">
                  Pioneering <span className="text-black font-bold">Solutions</span> through <span className="text-[#9E0203] font-bold">Technical Mastery</span>.
                </p>
             </div>
           </div>
