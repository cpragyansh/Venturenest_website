    ...
    <Box sx={{ 
      ...
      <Box
        sx={{
          ...
          width: '100%',
          height: '100%',
          // UPDATED: Darker grid lines (0.1 opacity) with a slight blue tint
          backgroundImage: `
            linear-gradient(rgba(27, 72, 128, 0.1) 1px, transparent 1px),
            linear-gradient(90deg, rgba(27, 72, 128, 0.1) 1px, transparent 1px)
          `,
          backgroundSize: '40px 40px',
          backgroundAttachment: 'fixed', // Grid stays fixed while scrolling
          zIndex: 0,
          pointerEvents: 'none',
        }}
      />
      ...
      >
        ...
        <Container maxWidth="md" sx={{ position: 'relative', zIndex: 2 }}>
          ...
          >
            The <strong style={{ color: '#000' }}>Advisory Council</strong> at CGC VentureNest brings together distinguished experts and thought leaders who guide our startups with strategic insights, mentorship and industry foresight. Their role is pivotal in shaping long-term growth, identifying market trends and ensuring that our incubated ventures remain aligned with evolving innovation.
          </Typography>
        </Container>
      </Box>
