...
export default function InvestandFundCouncil() {
  ...
  return (
    <div className="min-h-screen bg-white font-jakarta">
      ...
      <section 
        ...
        style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1553729459-efe14ef6055d?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80")' }}
      >
          ...
          <div className="max-w-4xl space-y-10">
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <span className="text-white/60 font-semibold uppercase tracking-[0.3em] text-[11px]">Capital Growth</span>
              </div>
              <h1 className="text-white text-6xl md:text-9xl font-extralight font-jakarta leading-[1] tracking-tight">
                Invest & <br />
                <span className="font-bold text-[#9E0203]">Fund.</span>
              </h1>
            </div>
            ...
            <div className="space-y-6 border-l-2 border-white/10 pl-8 ml-1">
              <p className="text-gray-300 text-xl font-light leading-relaxed max-w-2xl">
                Fueling the next wave of <span className="text-white font-medium">exponential growth</span> through strategic capital allocation and investor readiness.
              </p>
              
              <button className="flex items-center gap-4 text-white hover:text-[#9E0203] transition-colors group">
                <span className="text-sm font-bold uppercase tracking-widest text-white/40 group-hover:text-[#9E0203]">Access Investment Networks</span>
           ...
           <div className="relative w-full flex flex-col items-center justify-center mb-12 py-2">
             ...
             <div className="relative z-10 flex flex-col items-center">
                ...
                <p className="text-gray-600 max-w-2xl text-center text-lg font-medium leading-relaxed">
                  Empowering <span className="text-black font-bold">Innovation</span> through <span className="text-[#9E0203] font-bold">Strategic Capital</span>.
                </p>
             </div>
           </div>
