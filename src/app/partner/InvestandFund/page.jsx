          ...
          <div className="flex flex-col md:flex-row items-center gap-12 md:gap-20">
            <div className="w-full md:w-7/12 space-y-8 text-left">
              <div className="flex items-center space-x-4">
                ...
                <span className="text-white/60 font-black uppercase tracking-[0.5em] text-[10px]">Capital Access</span>
              </div>
              ...
              <div className="space-y-4">
                ...
                <p className="text-gray-400 text-lg font-medium leading-relaxed max-w-2xl">
                   The <strong className="text-white">Investment and Funding Council</strong> empowers startups with critical financial knowledge, investor readiness and access to funding networks—ensuring that startups are well-equipped to secure capital.
                </p>
              </div>
            </div>
