    ...
    <Box sx={{
      ...
      >
        ...
        <Container maxWidth="md" sx={{ position: 'relative', zIndex: 2 }}>
          ...
          >
            The <strong style={{ color: '#000' }}>Mentorship Council</strong> is dedicated to personalized, hands-on support for startups through strategic guidance, workshops and one-on-one coaching. It helps founders tackle business and operational challenges by matching them with the right mentors to support their specific startup journey.
          </Typography>
        </Container>
      </Box>
