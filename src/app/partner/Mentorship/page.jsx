          ...
          <div className="flex flex-col md:flex-row items-center gap-12 md:gap-20">
            <div className="w-full md:w-7/12 space-y-8 text-left">
              <div className="flex items-center space-x-4">
                ...
                <span className="text-white/60 font-black uppercase tracking-[0.5em] text-[10px]">Hands-on Guidance</span>
              </div>
              ...
              <div className="space-y-4">
                ...
                <p className="text-gray-400 text-lg font-medium leading-relaxed max-w-2xl">
                   The <strong className="text-white">Mentorship Council</strong> is dedicated to personalized, hands-on support for startups through strategic guidance, workshops and one-on-one coaching to help founders tackle business and operational challenges.
                </p>
              </div>
            </div>
             ...
             <div className="w-full md:w-5/12 hidden md:block relative">
                ...
                <div className="w-full aspect-square border-2 border-dashed border-[#9E0203]/30 rounded-full animate-[spin_60s_linear_infinite] flex items-center justify-center p-12">
                   <div className="w-full h-full border border-white/10 rounded-full flex items-center justify-center">
                      <div className="text-[#9E0203] text-6xl font-black">M</div>
                   </div>
                </div>
            </div>
          </div>
      ...
      <section className="py-24 bg-white relative">
        <div className="container mx-auto px-4">
           <div className="mb-16 border-b-4 border-black inline-block pr-12 pb-2">
             <span className="text-[#9E0203] font-black uppercase tracking-[0.4em] text-[10px] block mb-2">Guides</span>
             <h2 className="text-4xl font-black text-black uppercase tracking-tighter">Our Mentors</h2>
           </div>
           ...
           {loading && (
            ...
            {!loading && members.length === 0 && (
               <div className="text-center py-20 bg-gray-50 rounded-lg border-2 border-dashed border-gray-200">
                  <p className="text-gray-400 font-black uppercase tracking-widest">No mentors found currently.</p>
               </div>
            )}
