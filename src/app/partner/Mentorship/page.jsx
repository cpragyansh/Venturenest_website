...
export default function MentorshipCouncil() {
  ...
  return (
    ...
    //       <h1 className="council-block-2-head-main-text-area">Mentorship Council</h1>
    //     </div>
    ...
    //         ))
    //       ) : (
    //         <p className="no-members-message">No Mentorship council members found.</p>
    //       )}
    //     </div>
    //   </div>
    // </div>
     <div>
      <div className="council-block-1-main-bg-img-section">
        ...
        <div className="council-block-1-main-heading">
  <h1 className="council-block-1-head-main-text-area">Mentorship Council</h1>

  <div className="council-description-wrapper">
    <p className="council-description">
      The <strong>Mentorship Council</strong> is dedicated to personalized, hands-on support for startups through strategic guidance, workshops and one-on-one coaching. It helps founders tackle business and operational challenges by matching them with the right mentors to support their specific startup journey.
