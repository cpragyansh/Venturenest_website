...
export default function LegalComplianceCouncil() {
  ...
  useEffect(() => {
    // Fetch Legal & Compliance council members from backend
  ...
  <h1 className="council-block-1-head-main-text-area">Legal & Compliance Council</h1>

  <div className="council-description-wrapper">
    <p className="council-description">
      The <strong> Legal & Compliance Council </strong> ensures that startups at VentureNest operate on a legally sound foundation. It supports entrepreneurs with IP protection, regulatory compliance, contract management and legal literacy—empowering them to build robust and risk-aware businesse.
