...
import InViewRenderer from '../utils/InViewRenderer';
  ...
  return (
    <div className="min-h-screen bg-white font-jakarta overflow-x-hidden w-full relative">
      ...
      <section id="about" className="relative flex min-h-[500px] md:min-h-[700px] overflow-hidden">
        ...
        <div className="absolute inset-0 w-full h-full bg-cover bg-no-repeat" style={{ backgroundImage: "url('/assets/DSC_5258%20(1).jpg')", backgroundPosition: 'center', willChange: 'transform' }}></div>
          ...
          <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="max-w-2xl pt-4">
                ...
                <div className="pt-4">
                  <Link to="/IncubateWithUs" className="inline-flex items-center space-x-4 group bg-brand-dark text-white px-8 py-4 rounded-xl font-bold uppercase text-sm hover:bg-black transition-all shadow-xl">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 h-full">
                ...
                <div className="bg-white p-6 rounded-[32px] border border-gray-100 shadow-sm md:hover:shadow-xl transition-all duration-500 overflow-hidden relative group">
                ...
                <div className="bg-brand-red p-6 rounded-[16px] shadow-lg md:hover:shadow-red-200/50 transition-all duration-500 flex flex-col justify-between overflow-hidden relative group">
                  <div className="relative z-10">
                  ...
                  {/* Add the PNG of assured image here */}
                    <img src="/assets/newImage.svg" alt="Startups Graph" className="absolute bottom-0 right-0 w-full h-32 object-contain opacity-20 md:group-hover:scale-110 transition-transform duration-500" />
                  {/* <div className="absolute -right-4 -bottom-4 w-24 h-24 bg-white/10 rounded-full blur-2xl"></div> */}
                </div>

                {/* Patents Stat - Bar Graph Style */}
                <div className="bg-gray-50 p-6 rounded-[32px] border border-gray-200 md:hover:border-brand-red transition-all duration-500 flex flex-col justify-between group">
                  <div>
                ...
                <div className="bg-brand-dark p-6 rounded-[32px] shadow-2xl transition-all duration-500 flex flex-col items-center justify-center text-center relative overflow-hidden group">
                  <div className="relative z-10">
                    <div className="text-white text-4xl sm:text-5xl md:text-6xl font-black mb-1 md:group-hover:scale-110 transition-transform">10+</div>
      ...
      <InViewRenderer minHeight="100px" rootMargin="400px">
        <div id="council">
      ...
      <InViewRenderer minHeight="300px" rootMargin="400px">
        <div id="programs">
